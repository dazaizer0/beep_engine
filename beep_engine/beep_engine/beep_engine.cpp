#include "beep_libs.h"
#include "beep_funcs.h"
#include "beep_variables.h"
#include "beep.h"
...
int main(int argc, char* argv[])
{
    ...
    std::cout << "base_frequency: " << base_frequency << ", " << "base_duration: " << base_duration << std::endl;
...
#define PINK    "\033[95m"
        ...
        default:
            std::cout << "beep_engineing..." << std::endl;
            goto MENU;
        }
    }
    else
