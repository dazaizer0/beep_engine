...
{
    const std::string hello_message = " <- base_frequency, beepboard[play = [f, g, h, j, k], tone_controls[+, -], quit[/]: ";
...
int main()
{
    ...
    const std::string program_message = "Welcome to beep_engine2023!: ";
    ...
    const std::string hello_message = "[1 - beep_map], [2 - beepboard], [3 - beeplist]: ";
    for (const char i : hello_message) 
    {
        std::cout << i;
        Sleep(25);
